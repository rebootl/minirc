...
echo "==> Installing /sbin/sminirc, /sbin/sminirc-shutdown, /etc/minirc.conf"
install -Dm755 sminirc "$ROOT"/sbin/sminirc
install -Dm755 sminirc-shutdown "$ROOT/sbin/sminirc-shutdown"
